 ...
 */
final class Version20240217143312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_user_id INT DEFAULT NULL, DROP id_user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_user INT NOT NULL, DROP id_user_id');
    }
}
