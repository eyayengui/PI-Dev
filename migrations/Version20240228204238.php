 ...
 */
final class Version20240228204238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation DROP idp, DROP idt');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_964685A6B49202 ON consultation');
        $this->addSql('DROP INDEX IDX_964685A68FD60555 ON consultation');
        $this->addSql('ALTER TABLE consultation ADD idp INT NOT NULL, ADD idt INT NOT NULL');
