 ...
 */
final class Version20240228203929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE consultation ADD idp_id INT NOT NULL, ADD idt_id INT NOT NULL, DROP idp, DROP idt');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_964685A6B49202 ON consultation');
        $this->addSql('DROP INDEX IDX_964685A68FD60555 ON consultation');
        $this->addSql('ALTER TABLE consultation ADD idp INT NOT NULL, ADD idt INT NOT NULL, DROP idp_id, DROP idt_id');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A6B49202 FOREIGN KEY (idp) REFERENCES user (id)');
        $this->addSql('ALTER TABLE consultation ADD CONSTRAINT FK_964685A68FD60555 FOREIGN KEY (idt) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_964685A6B49202 ON consultation (idp)');
        $this->addSql('CREATE INDEX IDX_964685A68FD60555 ON consultation (idt)');
    }
}
